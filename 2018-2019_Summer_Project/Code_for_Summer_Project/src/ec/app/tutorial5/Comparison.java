...
public class Comparison {
    ...
    public static void main(String[] args) {
        ...
        seedGenerator.setSeed(0);
        ArrayList<String> comparision = new ArrayList<>();
        String resultpath = "C:\\Users\\vince\\Desktop\\123\\result.txt";//checker
        try {
...
//			int alg = ALGORITHM_RANDOM;
            ...
            FileWriter writeFile = new FileWriter("C:\\Users\\vince\\Desktop\\123\\comparision.txt");
            ...
            for (int pp = 0; pp < 30; pp++) {
                ...
                int v = 0;
                System.out.println("This is Run : " + pp);
...
//                            PSO pso = new PSO(clone_task,ls_vms,-1);
                            PSO pso = new PSO(ls_tasks,ls_vms,pp);
                            Comparison.pso = pso;
...
//                        udpatedVal,updated_task_list = pso.taskMapping(0);
                ...
                if(alg==5){
                     comparision.add("average total cost : " + average_total);
                     comparision.add("average makespan : "+ average_makespan);
                }
                //***************PSO
//				if (alg == 5) {// PSO
...
//				} else {
            ...
            for(int index = 0; index < comparision.size(); index++ ) {
                writeFile.write(comparision.get(index));
                writeFile.write("\n");
            }
        } catch (Exception e) {
            e.printStackTrace();
